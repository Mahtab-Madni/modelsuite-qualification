  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[480px_1fr]">
      ...
      <div className="relative flex flex-col justify-center px-14 py-16 bg-bg-card border-r border-border overflow-hidden sidebar-glow animate-fade-in">
        <div
          className="mb-10 relative z-10 animate-fade-slide"
          style={{
        ...
        <div
          className="mb-10 text-center relative z-10 animate-fade-slide"
        ...
        <form
          ...
          className="flex flex-col gap-5 relative z-10 animate-fade-slide"
      ...
      >
        ...
        <div className="relative z-10 max-w-[440px] w-full">
          ...
          >
            Resolve assigned issues and submit tasks via PR for core team review
            in our selection process.
          </p>
          <div className="flex gap-10">
            {[
              { num: "PR", label: "Submission Format", delay: "0.4s" },
              { num: "Core", label: "Team Review", delay: "0.45s" },
              { num: "100%", label: "Skill Focus", delay: "0.5s" },
            ].map(({ num, label, delay }) => (
              <div
                key={label}
