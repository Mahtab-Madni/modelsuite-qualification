...
const SubmissionsPage = () => {
  ...
  const needsRevision = submissions.filter(
    (s) => s.reviewStatus === "Request Revision",
  ).length;
      ...
      <main className="ml-60 flex-1 px-10 py-9">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-text-muted">
            Review talent submissions, request revisions, or approve/reject
            them.
          </p>
        </div>
                    ...
                    >
                      ...
                      <td className={tdCls}>
                        {sub.fileUrl ? (
                          ...
                          <span className="text-text-faint text-[13px] italic">
                            None
                          </span>
                        )}
                      </td>
                      ...
                      <td
                        className={`${tdCls} text-text-muted text-[13px] whitespace-nowrap`}
                      >
                        {sub.createdAt}
                      </td>
                      ...
                      <td className={tdCls}>
                        <span
                          className={`inline-block px-2.5 py-[3px] rounded-full text-[11px] font-semibold ${REVIEW_STATUS_CLASS[sub.reviewStatus] || "status-badge-Submitted"}`}
                        >
